...
export default function Ad({ autoplay = true, autoplayInterval = 5000 }) {
  const slides = ["/slider.jpeg", "/slider2.jpeg", "/slider3.jpeg","/slider4.jpeg","/slider5.jpeg"];
  ...
  return (
    <section aria-label="Promotional carousel" className="relative bg-white">
      <div style={fullBleedStyle} className="bg-transparent">
        <div
          className="relative overflow-hidden h-64 sm:h-96 lg:h-96 xl:h-[85vh]"
          // h-64 (256px) for small mobile screens
          // sm:h-96 (384px) for medium mobile/tablet screens
          // lg:h-96 keeps the default slider size for laptops
          // xl:h-[85vh] (85% of viewport height) for extra-large desktop screens
        >
          {/* Slide Track */}
          <div
          ...
          >
            <span className="text-green-700 text-xl md:text-2xl leading-none">
              ‹
            </span>
          </button>
